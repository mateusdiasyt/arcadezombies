package entities.towers.fire
{
   ...
   public class FireTower5 extends FireTower
   {
      
      public function FireTower5()
      {
         super(5,29);
         this.turret = new Image(Assets.GFX_TOWER_SPRITESHEET,Assets.TURRETS["fire"][5]);
         this.level = 5;
      ...
      {
         Globals.tracker.incrementData(Tracker.FIRE_LEVEL_5,1);
         super.tower_placed();
      }
   }
}

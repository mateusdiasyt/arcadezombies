package entities.towers.laser
{
   ...
   public class LaserTower3 extends LaserTower
   {
      
      public function LaserTower3()
      {
         super(8,42);
         this.turret = new Image(Assets.GFX_TOWER_SPRITESHEET,Assets.TURRETS["laser"][3]);
         this.level = 3;
      ...
      override protected function shoot() : void
      {
         ...
         var laser:Laser = new Laser(bx,by,this,this.target,3);
      }
   }
}

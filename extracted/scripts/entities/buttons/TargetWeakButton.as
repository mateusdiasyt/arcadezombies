package entities.buttons
{
   ...
   public class TargetWeakButton extends Button
   {
      ...
      public function TargetWeakButton(t:TowerEntity, on:Boolean = false, disabled:Boolean = false)
      {
         super();
         this.target = t;
      ...
      override public function clickAction() : void
      {
         if(!this._disabled)
         {
            this.target.setTargetState(TowerEntity.TARGET_WEAKEST);
            this.sm.play("on");
         }
      }
   }

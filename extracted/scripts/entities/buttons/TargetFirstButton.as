package entities.buttons
{
   ...
   public class TargetFirstButton extends Button
   {
      ...
      public function TargetFirstButton(t:TowerEntity, on:Boolean = false, disabled:Boolean = false)
      {
         super();
         this.target = t;
      ...
      override public function clickAction() : void
      {
         if(!this._disabled)
         {
            this.target.setTargetState(TowerEntity.TARGET_FIRST);
            this.sm.play("on");
         }
      }
   }

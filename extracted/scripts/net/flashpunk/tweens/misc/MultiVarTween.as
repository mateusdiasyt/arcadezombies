package net.flashpunk.tweens.misc
{
   ...
   public class MultiVarTween extends Tween
   {
      ...
      private var _vars:Vector.<String> = new Vector.<String>();
      
      private var _start:Vector.<Number> = new Vector.<Number>();
      
      private var _range:Vector.<Number> = new Vector.<Number>();
      ...
      {
         super.update();
         for(var i:int = int(this._vars.length); Boolean(i--); )
         {

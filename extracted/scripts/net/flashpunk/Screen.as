package net.flashpunk
{
   ...
   public class Screen
   {
      ...
      public function update() : void
      {
         ...
         this._matrix.tx += this._originX * this._scaleX * this._scale + this._x;
         this._matrix.ty += this._originY * this._scaleX * this._scale + this._y;
